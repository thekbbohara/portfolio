...
export const Dialog = forwardRef<HTMLDialogElement, DialogProps>(
  ({ children, className, ...props }, ref) => {
    ...
    return (
      <dialog ref={ref} className={cn("bg-s1 p-4 rounded-md", className)} {...props}>
        {children}
      </dialog>
    );
  }
...
export const DialogTitle = ({ children, className, ...props }: { children?: ReactNode; className?: string }) => {
  return <div className={cn("bg-transparent font-bold text-xl", className)} {...props}>
    {children}
  </div>
}
...
export const DialogFooter = ({ children, className, ...props }: { children?: ReactNode; className?: string }) => {
  return <div className={cn("bg-transparent", className)} {...props}>
    {children}
  </div>
}
